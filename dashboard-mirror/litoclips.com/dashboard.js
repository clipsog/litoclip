    ...
    list.innerHTML = accounts.map(acc => {
      ...
      return `
        <div style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 20px; margin-bottom: 16px;">
          ...
          ${acc.status === 'pending' ? `
            <div style="background: rgba(20, 184, 166, 0.1); border: 1px solid rgba(20, 184, 166, 0.3); border-radius: 8px; padding: 12px; margin-bottom: 12px;">
              <div style="font-size: 12px; color: rgba(255,255,255,0.8); margin-bottom: 8px;">Verification Code:</div>
              <div style="font-size: 18px; font-weight: 700; color: #14b8a6; letter-spacing: 2px; font-family: 'Courier New', monospace;">${acc.verificationCode}</div>
            </div>
          ` : ''}
